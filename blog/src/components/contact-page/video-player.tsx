...
const VideoPlayer: React.FC = () => {
  return (
    <div className="mt-[40px] rounded-3xl relative z-10 video-container">
      <h1 className="text-[32px] font-extrabold font-fustat text-center text-[#4B50A2]">Let’s collaborate and build meaningful things</h1>
      <p className=" text-center text-[#4B50A2] text-s mb-8">
