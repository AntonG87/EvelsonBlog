  ...
  return(
    <>
        <Container className={"max-w-[1140px] m-auto"}>
          <BackgroundBubbles className={'top-[35%] w-[100%]'} />
          <VectorAbout className={'flex justify-between items-center relative z-10 mt-[60px]'}/>
          <AboutList className={'grid-cols-2 grid gap-[40px] mt-[80px] relative z-10 mb-[75px]'}/>
        </Container>
      <footer>
