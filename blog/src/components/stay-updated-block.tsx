  ...
  return (
    <div className={className}>
      <div className={'pt-[45px]'}>
        ...
        <p className={'text-[14px] text-gray-600 font-fustat mb-1 mt-4 font-bold '}>Subscribe to our newsletter to receive the latest articles and updates.</p>
        <p className={'text-[12px] text-gray-600 font-fustat mb-6 font-bold '} >Everyone can share their results. Subscription allows you to follow my posts.</p>
